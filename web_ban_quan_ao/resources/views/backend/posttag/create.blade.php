...
<div class="card">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Thêm Mới Tag</h6>
    </div>
    <div class="card-body">
      <form method="post" action="{{route('post-tag.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Tên thẻ tag"  value="{{old('title')}}" class="form-control">
          @error('title')
