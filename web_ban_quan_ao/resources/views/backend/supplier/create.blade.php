...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('supplier.store')}}">
        ...
        <input id="inputTitle" type="text" name="tenncc" placeholder="Nhập tên nhà cung cấp"  value="{{old('title')}}" class="form-control">
        @error('title')
        ...
        <input id="inputTitle" type="text" name="diachi" placeholder="Nhập địa chỉ"  value="{{old('address')}}" class="form-control">
        @error('address')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
        ...
        <input id="inputTitle" type="text" name="phone" placeholder="Nhập số điện thoại"  value="{{old('phone')}}" class="form-control">
        @error('phone')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
        ...
        <input id="inputTitle" type="text" name="email" placeholder="Nhập email"  value="{{old('email')}}" class="form-control">
        @error('email')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
